...
def test_pyproject_declares_hermes_entry_point() -> None:
    ...
    assert project["version"] == "4.5.7"  # v4.5.7 — connect() accepts framework is_reconnect kwarg (fixes reconnect TypeError that dead-looped the longpoll consumer).
